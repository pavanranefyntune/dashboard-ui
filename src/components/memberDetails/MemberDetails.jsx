...
import TeamMember from "../Dashboard/Dashboard Sidebar/Team member/TeamMember";
const MemberDetails = () => {
  const { id } = useParams();
          ...
          {memberDetails && (
            <div className=" flex flex-col  items-center gap-4 p-4 shadow-2xl">
              ...
              <p className="px-8 text-center">
                ...
                Asperiores earum ab quaerat ullam maxime deleniti quas
                reiciendis iure nostrum perspiciatis! Sunt quo et debitis
                officia voluptatem labore aliquam nostrum architecto!
              </p>
